<div class="space-y-6">
    ...
    <div>
        <h1 class="text-2xl font-black">إعدادات الشركة</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400">
            تحديث بيانات الشركة وكلمة المرور
        </p>
    </div>
    ...
    <div class="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-5">
        <h2 class="font-black mb-4">بيانات الشركة</h2>

        <div class="grid gap-4 sm:grid-cols-2">
            <div>
                <label class="text-sm font-bold">اسم الشركة</label>
            ...
            <div>
                <label class="text-sm font-bold">البريد الإلكتروني</label>
